...
def banner():
	print(f"
    ____             __              __  
   / __ \_________ _/ /_  ___  _____/ /_ 
  / /_/ / ___/ __ `/ __ \/ _ \/ ___/ __ \
 / ____/ /  / /_/ / /_/ /  __(__  ) / / /
/_/   /_/   \__,_/_.___/\___/____/_/ /_/ 
                                         \u001b[31mv4
\033[1;37m----------------------------------------------
 GITHUB   :  PRABESH EXE
 YOUTUBE   : PRABESH GAMING STUDIO 
 FACEBOOK   : प्रवेश पौडेल
...
def setting():
	linex()
	print(" [\u001b[36m1\033[1;37m] ONLY PURANOIDZ")
...
def passwrd():
	...
	linex()
	print(f' \u001b[36m>> \033[1;37m️USE ID AAYNW VANEYY FLIGHT MODE ON OFF HAN HAI MUGI ')
	linex()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[PRABESH-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
